 ...
 * testColorIsHex
 */
declare function testColorIsHex(value: unknown): boolean;
/**
 ...
 */
declare function sortByKey(array: Array<object> | undefined, key: string, type?: string): object[];

export { type ParseUrl, type PollForProcessingImageOptions, convertColorHexToRgb, encodeBase64, getFormat, getPublicId, getTransformations, normalizeNumberParameter, objectHasKey, parseUrl, pollForProcessingImage, sortByKey, testColorIsHex };
