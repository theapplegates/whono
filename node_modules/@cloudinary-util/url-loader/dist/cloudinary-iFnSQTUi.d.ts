...
import { AspectRatio, CropMode, Gravity, Zoom, Height, Width, X, Y, PositionalOptions, Angle, FlagsDefinition, ListableFlags, Format, ListablePrompts, ExtractMode, Multiple } from './constants/parameters.js';
import { Q as QualifierConfig, a as QualifierConverters } from './qualifiers-NrbTECaq.js';
import { PluginResults } from './types/plugins.js';
...
declare const CroppingPlugin: TransformationPlugin<"all", "Cropping", CroppingPlugin.Options, boolean>;

declare const primary: {
    [k in OptionName]?: QualifierConfig;
};
declare const position: {
    [k in keyof PositionalOptions]-?: QualifierConfig;
};
declare const text: Record<string, QualifierConfig | undefined>;
...
declare const effects: {
    ...
    readonly color: {
        ...
        readonly converters: QualifierConverters[];
    };
    readonly colorize: {
        readonly prefix: "e";
...
declare namespace EffectsPlugin {
    interface NestableOptions extends QualifierOptions {
    }
    interface Options extends NestableOptions {
        /**
...
declare const EffectsPlugin: TransformationPlugin<"all", "Effects", EffectsPlugin.Options, boolean>;
...
declare const FlagsPlugin: TransformationPlugin<"all", "Flags", FlagsPlugin.Options, boolean>;
...
declare const NamedTransformationsPlugin: TransformationPlugin<"all", "NamedTransformations", NamedTransformationsPlugin.Options, boolean>;
...
declare const OverlaysPlugin: TransformationPlugin<"all", "Overlays", OverlaysPlugin.Options, boolean>;

declare namespace PreserveTransformationsPlugin {
    interface Options {
        /**
...
declare const PreserveTransformationsPlugin: TransformationPlugin<"all", "PreserveTransformations", PreserveTransformationsPlugin.Options, boolean>;
...
declare const RawTransformationsPlugin: TransformationPlugin<"all", "RawTransformations", RawTransformationsPlugin.Options, boolean>;
...
declare const RemoveBackgroundPlugin: TransformationPlugin<"image", "RemoveBackground", RemoveBackgroundPlugin.Options, boolean>;
...
declare const SanitizePlugin: TransformationPlugin<"image", "Sanitize", SanitizePlugin.Options, true>;
...
declare const SeoPlugin: TransformationPlugin<"all", "Seo", SeoPlugin.Options, boolean>;
...
declare const UnderlaysPlugin: TransformationPlugin<"all", "Underlays", UnderlaysPlugin.Options, boolean>;
...
declare const VersionPlugin: TransformationPlugin<"all", "Version", VersionPlugin.Options, boolean>;
...
declare const ZoompanPlugin: TransformationPlugin<"image", "Zoompan", ZoompanPlugin.Options, boolean>;

type SupportedAssetTypeInput = SupportedAssetType | "videos" | "images";
interface BaseAssetOptions<assetType extends SupportedAssetTypeInput = SupportedAssetTypeInput> {
    /**
...
interface AssetOptions<assetType extends SupportedAssetTypeInput = SupportedAssetTypeInput> extends BaseAssetOptions<assetType>, CroppingPlugin.Options, EffectsPlugin.Options, FlagsPlugin.Options, NamedTransformationsPlugin.Options, OverlaysPlugin.Options, PreserveTransformationsPlugin.Options, RawTransformationsPlugin.Options, RemoveBackgroundPlugin.Options, SanitizePlugin.Options, SeoPlugin.Options, UnderlaysPlugin.Options, VersionPlugin.Options, ZoompanPlugin.Options {
}
...
declare const DefaultImagePlugin: TransformationPlugin<"image", "DefaultImage", DefaultImagePlugin.Options, boolean>;

declare namespace EnhancePlugin {
    interface Options {
        /**
...
declare const EnhancePlugin: TransformationPlugin<"image", "Enhance", EnhancePlugin.Options, boolean>;

declare namespace ExtractPlugin {
    interface Options {
        /**
...
declare const ExtractPlugin: TransformationPlugin<"image", "Extract", ExtractPlugin.Options, boolean>;
...
declare const FillBackgroundPlugin: TransformationPlugin<"image", "FillBackground", FillBackgroundPlugin.Options, boolean>;
...
declare namespace RecolorPlugin {
    interface Options {
         ...
         */
        recolor?: string | ReadonlyArray<string> | readonly [ReadonlyArray<string>, ...Array<string>] | NestedOptions;
    }
    interface NestedOptions {
        prompt?: ListablePrompts;
        to?: string;
...
declare const RecolorPlugin: TransformationPlugin<"image", "Recolor", RecolorPlugin.Options, boolean>;
...
declare const RemovePlugin: TransformationPlugin<"image", "Remove", RemovePlugin.Options, boolean>;

declare namespace ReplaceBackgroundPlugin {
    interface Options {
        /**
...
declare const ReplaceBackgroundPlugin: TransformationPlugin<"image", "ReplaceBackground", ReplaceBackgroundPlugin.Options, boolean>;
...
declare const ReplacePlugin: TransformationPlugin<"image", "Replace", ReplacePlugin.Options, boolean>;
...
declare const RestorePlugin: TransformationPlugin<"image", "Restore", RestorePlugin.Options, boolean>;

interface ImageOptions extends AssetOptions, DefaultImagePlugin.Options, EnhancePlugin.Options, ExtractPlugin.Options, FillBackgroundPlugin.Options, RecolorPlugin.Options, RemovePlugin.Options, ReplacePlugin.Options, ReplaceBackgroundPlugin.Options, RestorePlugin.Options, ZoompanPlugin.Options {
}

interface VideoOptions extends AssetOptions, AbrPlugin.Options {
}

interface AllOptions extends AssetOptions, ImageOptions, VideoOptions {
}
type CloudinaryKey = keyof AllOptions & {};
type SupportedAssetType = "image" | "video" | "all";
type OptionName = keyof AllOptions;
type ApplyWhen = OptionName | ((opts: AllOptions) => boolean);
type AlwaysApply = () => true;
interface PluginDefinition<assetType extends SupportedAssetType, name extends string, options extends object, alwaysApply extends boolean> {
    name: name;
    supports: assetType;
...
interface TransformationPlugin<assetType extends SupportedAssetType = SupportedAssetType, name extends string = string, opts extends object = object, alwaysApply extends boolean = boolean> {
    name: name;
    supports: assetType;
...
type OwnOptionsParam<opts extends object, alwaysApply extends boolean> = opts & ([alwaysApply] extends [true] ? {} : {
    [k in singleKeyOf<opts>]: Exclude<opts[k], undefined>;
});
type CtxParam<assetType extends SupportedAssetTypeInput> = assetType extends "all" ? AllOptions : assetType extends "video" | "videos" ? VideoOptions : ImageOptions;
type singleKeyOf<opts> = {
    [k in keyof opts]: keyof opts extends k ? k : never;
}[keyof opts];
type PluginApplicationDefinition<assetType extends SupportedAssetType, opts extends object, alwaysApply extends boolean> = (cldAsset: CldAsset, 
/** Options owned by this plugin */
opts: OwnOptionsParam<opts, alwaysApply>, ctx: CtxParam<assetType>) => PluginResults;
type PluginApplication<assetType extends SupportedAssetType, opts extends object, alwaysApply extends boolean> = (cldAsset: CldAsset, opts: OwnOptionsParam<opts, alwaysApply> & CtxParam<assetType>) => PluginResults;
declare const plugin: <asset extends SupportedAssetType, name extends string, opts extends object, alwaysApply extends boolean>(def: PluginDefinition<asset, name, opts, alwaysApply>) => TransformationPlugin<asset, name, opts, alwaysApply>;
 ...
 */
type OptionsInput = ImageOptions | VideoOptions;
/**
 * constructCloudinaryUrl
 * @description Builds a full Cloudinary URL using transformation plugins specified by options
 */
interface ConstructUrlProps<assetType extends SupportedAssetTypeInput = SupportedAssetTypeInput> {
    /**
...
type CldAsset = CloudinaryImage | CloudinaryVideo;
declare function constructCloudinaryUrl<assetType extends SupportedAssetTypeInput = "image">({ options, config, analytics }: ConstructUrlProps<assetType>): string;
/**
