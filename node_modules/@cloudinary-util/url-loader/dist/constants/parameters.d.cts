import { StringifiablePrimative } from '../lib/utils.cjs';
 ...
 */
type CropMode = "auto" | "crop" | "fill" | "fill_pad" | "fit" | "imagga_crop" | "imagga_scale" | "lfill" | "limit" | "lpad" | "mfit" | "mpad" | "pad" | "scale" | "thumb";
/**
...
/** Aspect Ratio */
type AspectRatioMode = "vflip" | "hflip" | "ignore" | "auto_right" | "auto_left";
/**
 ...
 */
type AspectRatio = AspectRatioMode | number | (string & {});
 ...
 *  @qualifier fl
 */
type FlagsDefinition = ListableFlags | FlagRecord;
type ListableFlags = Flag | ReadonlyArray<Flag>;
type FlagRecord = Partial<Record<Flag, StringifiablePrimative>>;
/**
 ...
 * @qualifier f
 */
type Format = "auto" | "auto:image" | "auto:animated" | "gif" | "png" | "jpg" | "bmp" | "ico" | "pdf" | "tiff" | "eps" | "jpc" | "jp2" | "psd" | "webp" | "zip" | "svg" | "webm" | "wdp" | "hpx" | "djvu" | "ai" | "flif" | "bpg" | "miff" | "tga" | "heic" | "default" | (string & {});
/**
 ...
 */
type ListablePrompts = string | ReadonlyArray<string>;
/**
...
export type { Angle, AspectRatio, AspectRatioMode, CropMode, ExtractMode, Flag, FlagRecord, FlagsDefinition, Format, Gravity, Height, ListableFlags, ListablePrompts, Multiple, PositionalOptions, Width, X, Y, Zoom };
