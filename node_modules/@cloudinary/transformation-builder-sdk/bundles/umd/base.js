(function (global, factory) {
    ...
    ***************************************************************************** */
     ...
     */
    var TrimAction$1 = /** @class */ (function (_super) {
        ...
        TrimAction.fromJson = function (actionModel) {
            var _a = actionModel, colorSimilarity = _a.colorSimilarity, colorOverride = _a.colorOverride;
     ...
     */
    function trim$1(colorSimilarity, colorOverride) {
        var trimAction = new TrimAction$1();
        if (colorSimilarity) {
    ...
    var ContrastAction = /** @class */ (function (_super) {
        __extends(ContrastAction, _super);
        ...
        ContrastAction.prototype.prepareQualifiers = function () {
            ...
            var qualifierValue = new QualifierValue(qualifierValueStr);
            this.addQualifier(new Qualifier('e', qualifierValue));
            return this;
        };
