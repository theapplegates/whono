...
function Tickets_plane($$anchor, $$props) {
  ...
  add_svelte_meta(
    () => Icon_default(node, spread_props({ name: "tickets-plane" }, () => props, {
      get iconNode() {
        return iconNode;
      }
    })),
...
if (import.meta.hot) {
  Tickets_plane = hmr(Tickets_plane);
  import.meta.hot.accept((module) => {
    Tickets_plane[HMR].update(module.default);
  });
}
var tickets_plane_default = Tickets_plane;

export {
  tickets_plane_default
};
//# sourceMappingURL=chunk-ZYGWZLVA.js.map
