...
function Package_plus($$anchor, $$props) {
  ...
  add_svelte_meta(
    () => Icon_default(node, spread_props({ name: "package-plus" }, () => props, {
      get iconNode() {
        return iconNode;
      }
    })),
...
if (import.meta.hot) {
  Package_plus = hmr(Package_plus);
  import.meta.hot.accept((module) => {
    Package_plus[HMR].update(module.default);
  });
}
var package_plus_default = Package_plus;

export {
  package_plus_default
};
//# sourceMappingURL=chunk-MB5CU737.js.map
