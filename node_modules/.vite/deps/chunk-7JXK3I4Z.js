...
function Package_search($$anchor, $$props) {
  ...
  push($$props, true, Package_search);
  ...
  add_svelte_meta(
    () => Icon_default(node, spread_props({ name: "package-search" }, () => props, {
      get iconNode() {
        return iconNode;
      }
    })),
...
if (import.meta.hot) {
  Package_search = hmr(Package_search);
  import.meta.hot.accept((module) => {
    Package_search[HMR].update(module.default);
  });
}
var package_search_default = Package_search;

export {
  package_search_default
};
//# sourceMappingURL=chunk-7JXK3I4Z.js.map
