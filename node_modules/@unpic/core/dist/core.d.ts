import { UrlTransformer, ImageCdn, UrlTransformerOptions } from 'unpic';
...
declare const getSrcSetEntries: ({ src, width, layout, height, aspectRatio, breakpoints, cdn, transformer, format, }: SrcSetOptions) => Array<UrlTransformerOptions>;
/**
